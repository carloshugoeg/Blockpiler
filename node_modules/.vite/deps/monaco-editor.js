...
import { a as MarkerSeverity, c as Range, d as Token, f as Uri, h as languages, i as KeyMod, l as Selection, m as editor_api2_exports, n as Emitter, o as MarkerTag, p as editor, r as KeyCode, s as Position, t as CancellationTokenSource, u as SelectionDirection } from "./editor.api2-CwS7sAJS.js";
import { t as monaco_contribution_exports$3 } from "./monaco.contribution-CHJSB7qk.js";
import { t as createWebWorker } from "./workers-y0EPnlI1.js";
import "C:/Users/carlo/Documents/Uni/compiladores/CompileFlow/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon.css";
import "C:/Users/carlo/Documents/Uni/compiladores/CompileFlow/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon-modifiers.css";
...
function getMode$2() {
	return import("./cssMode-C19fDAYM.js");
}
...
function getMode$1() {
	return import("./htmlMode-CmUf093a.js");
}
...
function getMode() {
	return import("./jsonMode-DxJ3zmM4.js");
}
languages.register({
	id: "json",
	extensions: [
...
registerLanguage({
	...
	extensions: [".abap"],
	aliases: ["abap", "ABAP"],
	loader: () => import("./abap-BiEXHsxh.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./apex-D64mw7bq.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./azcli-CrjNSnMM.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".bicep"],
	aliases: ["Bicep"],
	loader: () => import("./bicep-CHeQNEtq.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".mligo"],
	aliases: ["Cameligo"],
	loader: () => import("./cameligo-CMQwgu-4.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./clojure-b2ujN5LD.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./coffee-BC9RVFDo.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["C#", "csharp"],
	loader: () => import("./csharp-CcylutiH.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./cypher-Blpwfjo2.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./dart-CrB5Geje.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["Dockerfile"],
	loader: () => import("./dockerfile-DcEIeF2y.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./elixir-B9AcHthK.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./flow9-BEIUT6H6.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./fsharp-4xd3WRj_.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-Db1IAzKT.js").then((m) => m.TagAutoInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-Db1IAzKT.js").then((m) => m.TagAngleInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-Db1IAzKT.js").then((m) => m.TagBracketInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-Db1IAzKT.js").then((m) => m.TagAngleInterpolationBracket);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-Db1IAzKT.js").then((m) => m.TagBracketInterpolationBracket);
	}
});
registerLanguage({
...
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-Db1IAzKT.js").then((m) => m.TagAutoInterpolationBracket);
	}
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./graphql-BW-9g153.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./handlebars-DOlPkI1C.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./html-Dupc8CUA.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./java-D7md_T9J.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./javascript-byQ3dTku.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".jl"],
	aliases: ["julia", "Julia"],
	loader: () => import("./julia-Ct0ULe1_.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./kotlin-_EzMpWCR.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./less-DasutmMS.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".lex"],
	aliases: ["Lexon"],
	loader: () => import("./lexon-iwI-CIMt.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./liquid-Bxm_deaB.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./markdown-Db5doraJ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./mips-Ct60MxgZ.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["DAX", "MSDAX"],
	loader: () => import("./msdax-a8BBmibz.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [],
	aliases: ["MySQL", "mysql"],
	loader: () => import("./mysql-B2CTuKqz.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".m"],
	aliases: ["Objective-C"],
	loader: () => import("./objective-c-BoA55lEv.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pascal-Bk3wygu2.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pascaligo-CtgEix2E.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".pl", ".pm"],
	aliases: ["Perl", "pl"],
	loader: () => import("./perl-BLF6Q9Pk.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pgsql-VeLu9kFg.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./postiats-Bkz1DhDp.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./powerquery-C3EaDiKZ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./powershell-MiRjyk0E.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./protobuf-BstUBkfu.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./python-BHi2uHmv.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".qs"],
	aliases: ["Q#", "qsharp"],
	loader: () => import("./qsharp-C5XMWeSp.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./razor-_a8JU3qI.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".redis"],
	aliases: ["redis"],
	loader: () => import("./redis-mZADXCBe.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./redshift-ZZcpr3-d.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./restructuredtext-CiQA8IeC.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["Ruby", "rb"],
	loader: () => import("./ruby-CEps8kKk.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".rs", ".rlib"],
	aliases: ["Rust", "rust"],
	loader: () => import("./rust-B_Y5hbav.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scala-BTBjBSCK.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scheme-DEXqttQO.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scss-BjjP_Hg7.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".sh", ".bash"],
	aliases: ["Shell", "sh"],
	loader: () => import("./shell-DTI1ZXux.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./solidity-wYofvv1e.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./sophia-FgNILTNS.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./sparql-HJblDgnL.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./swift-ByWdsZBH.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./systemverilog-Cv1Thcip.js")
});
registerLanguage({
	id: "verilog",
	extensions: [".v", ".vh"],
...
registerLanguage({
	...
	loader: () => import("./twig-_SIWV9J2.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => {
		return import("./typescript-CiH1I2mq.js");
	}
});
//#endregion
...
registerLanguage({
	...
	extensions: [".tsp"],
	aliases: ["TypeSpec"],
	loader: () => import("./typespec-BX21G0me.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./wgsl-CoLZgINf.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./yaml-CkhVt9q2.js")
});
//#endregion
